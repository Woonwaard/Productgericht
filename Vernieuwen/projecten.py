import arcpy
#Versie 2.0, Projectenmodel vernieuwen
...
# Met het vernieuwen van de oefen laag en het script ervoor als basis maken wij een python scipt om Projecten model te vernieuwen
# van belang is om te weten dat relatie tussen projecten en clusters n:m is. 
...
# Parameters:
Clusterswoonwaard = r"C:\Projecten\Woonwaard_objecten\Woonwaard_objecten.gdb\WoonwaardClusterModel"
...
if (Aantal == 0).bool():
 print ("De invoer view Alle projecten is leeg")
 sys.exit(0)
...
print("Stap 4b van 6: Toevoegen veld Statusnieuw met eenduidige waarde voor alle projecten")
...
# Variabelen
username = "mdepender@woonwaard.nl"                           # AGOL Username
password = "St@dl3ven,dig292"                                 # AGOL Password
...
#gis = GIS("https://woonwaard.maps.arcgis.com", username, password)
gis = GIS('home')  #dit is de variant dat je al bent ingelogd
